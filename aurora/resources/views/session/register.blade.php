          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                @csrf
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="First Name" name="first_name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('first_name') }}">
                  @error('first_name')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                <div class="mb-3">
                  <input type="text" class="form-control" placeholder="Last Name" name="last_name" id="name" aria-label="Name" aria-describedby="name" value="{{ old('last_name') }}">
                  @error('last_name')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
        ...
        <form role="form" method="POST" action="/register">
          @csrf
            ...
            <div class="remember-forgot">
                <label for="remember" class="checkbox-label"><input type="checkbox" name="agreement" id="remember"> I agree to the terms & conditions</label>
            </div>
