        ...
        {{-- <div class="form-box upload-in-existed-file"> --}}
          ...
          <div class="modal-body">
            ...
            <form id="upload-csv-in-existed-list">
              ...
              <input type="hidden" name="token" value="{{$token}}" id="tokenoflist">
              <!-- <div class="md-3">
    ...
    <div class="modal-content">
      ...
      <form id="update-form">
        ...
        <div class="col-md-12 px-3">
          ...
          <button type="button" id="additional-attribute-btn btn btn-sm btn-info my-2">Additional Attribute</button>
        </div>
        <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="modal-footer">
        ...
        {{-- <div class="single-lead-add"> --}}
          ...
          <div class="modal-body">
            <form id="list-lead-manaully-user-add-form">
              @csrf
          ...
          <div class="card card-height mb-4">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center">
              ...
              <div class="add-btn-group">
                ...
                <button class="btn btn-sm btn-primary mb-0" data-bs-toggle="modal" data-bs-target="#static">Upload Csv</button>
              </div>
              <div class="search-box">
                <form action="{{route('list-leads',['token'=>$token])}}" method="get" class="search-form">
                  @if (isset($search))
                ...
                <table class="table align-items-center mb-0">
                      ...
                      <td colspan="9">
                        <div class="d-flex px-2 py-3 justify-content-center">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><a href="#" class="text-muted">No User Leads entry found in the System</a></h6>
                  ...
                  @foreach ($listLeads as $listLead)
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <button class="info-btn utility-icon" data-lead={{$listLead->token}}>
                          <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/></svg>
                        </button>
                        <button class="edit utility-icon" data-lead-token="{{$listLead->token}}">
                        ...
                        <button class="lead-delete-btn utility-icon" data-lead-token="{{$listLead->token}}">
